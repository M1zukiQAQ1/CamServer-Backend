...
public class UploadController {
    ...
    public ResponseEntity<?> uploadImage(
            ...
            @RequestParam("longtitude") long longtitude,
        ...
        try {
            ...
            if (filename.endsWith(".jpg") || filename.endsWith(".jpeg")) {
                ...
                //ToDo: FixMe!
//                imageService.save(new Image(camId, siteName, new Date(date), bit, gain, exposure,
//                        dest.getPath(), longtitude, latitude,
//                        temperature, humidity, timeZone));
            }
